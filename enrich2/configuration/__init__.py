...
class ConfigurationManager(object):
    """
    A utility class to load configuration files made from a `configurator`
    instance. Handles formatting and
    """

    def __init__(self, cfg):
        self._construct_from_json(cfg)
    ...
    def _construct_from_json(self, cfg):
        # Extract and test Experiment

        # Extract and parse Conditions

        # Extract and parse Selections
